  ...
  return (
    <>
      ...
      <div 
        ...
        `}
      >
        {/* UPDATED Header - App Bar Style with HydroDash + Map Icon + Settings Icon */}
        ...
        {/* Settings Panel (collapsible, appears when settings icon is clicked) */}
        {showSettings && (
        ...
        {/* REMOVED: Current Stream row (as requested) */}
